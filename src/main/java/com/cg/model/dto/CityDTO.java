...
public class CityDTO {
    ...
    @Min(value = 10, message = "Diện tích lớn hơn hoặc bằng 10 km2")
    private String area;

    @NotBlank(message = "Dân số không được để trống!")
    @Pattern(regexp = "^[0-9]+$", message = "Dân số phải là số nguyên!")
    @Min(value = 1, message = "Dân số phải lớn hơn hoặc bằng 1")
    private String population;

    @NotBlank(message = "GDP không được để trống!")
    @Pattern(regexp = "^[0-9]+$", message = "GDP phải là số nguyên!")
    @Min(value = 1, message = "GDP phải lớn hơn hoặc bằng 1")
    private String gdp;
